#Dieses Modul ruft die Reden der Bundestagsapi anhand eines im Input angegebenen Parameters auf.
# #Sucht die Rede der Politiker anhand verschiedener Bedingungen heraus
# und speichert das Ergebnis im extracted Dataframe mit einigen Identifiern
